...
mkdir -p /opt
curl -sSL https://github.com/wx257osn2/build-archive/releases/download/gcc-${GCC_VERSION}/ubuntu$(source /etc/os-release; echo ${VERSION_ID//./})-$(uname -m).tar.zst | tar -C /opt -Ipzstd -xf -
